...
class CPDataset(data.Dataset):
    ...
    def __init__(self, dataroot, image_size=512, mode='train', semantic_nc=13, unpaired=False):
        ...
        self.data_list = mode + '_pairs_230729.txt'
        ...
        with open(osp.join(dataroot, self.data_list), 'r') as f:
            for line in f.readlines():
                ...
                im_names.append(im_name.split('.')[0] + '.jpg')
                c_names.append(c_name.split('.')[0] + '.jpg')
    ...
    def __getitem__(self, index):
        ...
        # agnostic image
        inpaint_big = Image.open(osp.join(self.data_path, 'warp_feat_paired_gp', im_name))
...
if __name__ == '__main__':
    dataset = CPDataset('/mnt/pfs-mc0p4k/cvg/team/didonglin/why/datasets/Dresscode_upper_body_copy', 512, mode='train', unpaired=False)
