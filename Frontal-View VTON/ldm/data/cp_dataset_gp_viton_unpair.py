# coding=utf-8 cp_dataset_gp_viton_unpair
import os
    ...
    def __init__(self, dataroot, image_size=512, mode='train', semantic_nc=13, unpaired=False):
        ...
        with open(osp.join(dataroot, self.data_list), 'r') as f:
            for line in f.readlines():
                ...
                im_name = im_name.split('.')[0] + '.jpg'
                c_name = c_name.split('.')[0] + '.jpg'
...
if __name__ == '__main__':
    dataset = CPDataset('/mnt/pfs-mc0p4k/cvg/team/didonglin/why/datasets/VITON-HD', 512, mode='test', unpaired=True)
